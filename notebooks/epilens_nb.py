"""Shared scaffolding for the EpiLens notebooks.

This module is *not* part of the ``epilens`` package — it is notebook plumbing
...
None of this is how you would use EpiLens for real. In production you would
...
# --------------------------------------------------------------------------
# Path bootstrap — must run before any `epilens` import below.
# --------------------------------------------------------------------------
...
def find_project_root(start: Optional[Path] = None) -> Optional[Path]:
    ...
    for candidate in [start, *start.parents]:
        if (candidate / "src" / "epilens").exists():
            return candidate
    return None
...
from epilens.db.in_memory_academic_db import InMemoryAcademicDB  # noqa: E402
from epilens.rag.embeddings.base import Embedder  # noqa: E402
from epilens.rag.generation.base import Generator  # noqa: E402
from epilens.rag.indexing.chunking import FixedSizeChunker  # noqa: E402
from epilens.rag.indexing.indexer import Indexer  # noqa: E402
from epilens.rag.provenance import Provenance  # noqa: E402
from epilens.rag.retrieval.candidates import SemanticCandidateRetriever  # noqa: E402
from epilens.rag.retrieval.retriever import Retriever  # noqa: E402
from epilens.schemas import PaperMetadata, SearchResult, StructuredSection  # noqa: E402
from epilens.vectordb.file import FileDB  # noqa: E402

Papers = Dict[str, Dict[str, Any]]


def bootstrap(prefix: str = "epilens-notebook-") -> Path:

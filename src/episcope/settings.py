...
def env(name: str, default: Optional[str] = None, *, legacy_names: tuple[str, ...] = ()) -> Optional[str]:
...
class AppSettings:
    ...
    def from_env(cls) -> "AppSettings":
        ...
        return cls(
            ...
            ollama_host=env("OLLAMA_HOST", "http://localhost:11434") or "http://localhost:11434",
            api_host=env("EPISCOPE_API_HOST", "0.0.0.0") or "0.0.0.0",
            api_port=int(port_raw) if port_raw else 8000,
            api_base_url=env("EPISCOPE_API_BASE_URL", "http://localhost:8000") or "http://localhost:8000",

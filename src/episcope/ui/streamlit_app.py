...
def env(name: str, default: str | None = None, *, legacy_names: tuple[str, ...] = ()) -> str | None:
...
DEFAULT_API_BASE_URL = env("EPISCOPE_API_BASE_URL", "http://localhost:8000") or "http://localhost:8000"
print(f"Using API base URL: {DEFAULT_API_BASE_URL}")
print("Mongo URI configured:", bool(env("MONGO_URI", legacy_names=("mongo_uri",))))

...
from epilens.workflows.classification.output import CompletionSample
...
from epilens.workflows.classification.schemas import ClassificationResult
from epilens.workflows.classification.utils import PromptMessage

...
def load_workspace(path: str | Path) -> WorkspaceConfig:
    ...
    return WorkspaceConfig(
        ...
        loader=str(indexing.get("loader") or "pdfminer"),
        ...
        qdrant_collection=str(
            server.get("qdrant_collection") or "epilens_academic"
        ),
        mongo_db_name=str(server.get("mongo_db_name") or "epilens_academic_db"),

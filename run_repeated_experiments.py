...
def detailed_record_from_output(paper_id: str, detailed_output: Any) -> Dict[str, Any]:
    return {
        "paper_id": str(paper_id),
        ...
        try:
            ...
            for idx, paper_id in enumerate(paper_ids, start=1):
                ...
                try:
                    ...
                    provenance_record = detailed_record_from_output(paper_id, c_res)
                except Exception as e:
                    n_errors += 1
                    ...
                    if settings.record_failures:
                        ...
                        provenance_record = failure_record(paper_id, e)
                    else:
                        continue
